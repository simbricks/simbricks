...
source "qemu" "autogenerated_1" {
  ...
  iso_checksum     = "file:https://cloud-images.ubuntu.com/minimal/releases/jammy/release-20240207/SHA256SUMS"
  iso_url          = "https://cloud-images.ubuntu.com/minimal/releases/jammy/release-20240207/ubuntu-22.04-minimal-cloudimg-amd64.img"
  memory           = "${var.memory}"
