...
from ...models.runs_list_200_response import RunsList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    json_instantiation: None | str | Unset
    if isinstance(instantiation, Unset):
        json_instantiation = UNSET
    else:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RunsList200Response.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | RunsList200Response
    """
