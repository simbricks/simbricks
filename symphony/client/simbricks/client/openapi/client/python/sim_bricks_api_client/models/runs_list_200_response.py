...
T = TypeVar("T", bound="RunsList200Response")


@_attrs_define
class RunsList200Response:
    """RunsList200Response

    Attributes:
        data (list[Run] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[Run] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[Run] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = Run.from_dict(data_type_0_item_data)
        ...
        runs_list_200_response = cls(
            data=data,
            links=links,
        )

        runs_list_200_response.additional_properties = d
        return runs_list_200_response
