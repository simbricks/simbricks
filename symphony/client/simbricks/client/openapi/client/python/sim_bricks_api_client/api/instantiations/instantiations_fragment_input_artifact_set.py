...
from ...models.body_instantiations_fragment_input_artifact_set import BodyInstantiationsFragmentInputArtifactSet
...
def _get_kwargs(
    ...
    frag_id: str,
    *,
    body: BodyInstantiationsFragmentInputArtifactSet,
) -> dict[str, Any]:
