...
class RunStatus:
    ...
    Attributes:
        ...
        discriminator (Literal['RunStatus'] | Unset):  Default: 'RunStatus'.
    """
    ...
    discriminator: Literal["RunStatus"] | Unset = "RunStatus"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if discriminator != "RunStatus" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'RunStatus', got '{discriminator}'")
