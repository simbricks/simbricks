...
from ...models.systems_list_200_response import SystemsList200Response
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SystemsList200Response.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | SystemsList200Response
    """
