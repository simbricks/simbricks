...
class Simulation:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        system_id: None | str | Unset
        if isinstance(self.system_id, Unset):
            system_id = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_system_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        system_id = _parse_system_id(d.pop("system_id", UNSET))
