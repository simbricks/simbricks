...
T = TypeVar("T", bound="InstantitionsList200Response")


@_attrs_define
class InstantitionsList200Response:
    """InstantitionsList200Response

    Attributes:
        data (list[Instantiation] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[Instantiation] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[Instantiation] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = Instantiation.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[Instantiation] | None | Unset, data)
        ...
        instantitions_list_200_response = cls(
            data=data,
            links=links,
        )

        instantitions_list_200_response.additional_properties = d
        return instantitions_list_200_response
