...
T = TypeVar("T", bound="SimulationsList200Response")


@_attrs_define
class SimulationsList200Response:
    """SimulationsList200Response

    Attributes:
        data (list[Simulation] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[Simulation] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[Simulation] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = Simulation.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[Simulation] | None | Unset, data)
        ...
        simulations_list_200_response = cls(
            data=data,
            links=links,
        )

        simulations_list_200_response.additional_properties = d
        return simulations_list_200_response
