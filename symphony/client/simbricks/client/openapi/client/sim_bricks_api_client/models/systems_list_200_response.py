...
T = TypeVar("T", bound="SystemsList200Response")


@_attrs_define
class SystemsList200Response:
    """SystemsList200Response

    Attributes:
        data (list[System] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[System] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[System] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = System.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[System] | None | Unset, data)
        ...
        systems_list_200_response = cls(
            data=data,
            links=links,
        )

        systems_list_200_response.additional_properties = d
        return systems_list_200_response
