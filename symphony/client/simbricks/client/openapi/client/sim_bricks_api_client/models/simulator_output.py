...
T = TypeVar("T", bound="SimulatorOutput")
...
class SimulatorOutput:
    ...
    Attributes:
        ...
        discriminator (Literal['SimulatorOutput'] | Unset):  Default: 'SimulatorOutput'.
    """
    ...
    discriminator: Literal["SimulatorOutput"] | Unset = "SimulatorOutput"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discriminator = cast(Literal["SimulatorOutput"] | Unset, d.pop("discriminator", UNSET))
        if discriminator != "SimulatorOutput" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'SimulatorOutput', got '{discriminator}'")

        simulator_output = cls(
            output=output,
            is_stderr=is_stderr,
            simulator_id=simulator_id,
            run_id=run_id,
        ...
        simulator_output.additional_properties = d
