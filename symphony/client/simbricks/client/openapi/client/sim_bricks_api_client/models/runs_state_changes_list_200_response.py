...
if TYPE_CHECKING:
    ...
    from ..models.run_state_change import RunStateChange


T = TypeVar("T", bound="RunsStateChangesList200Response")


@_attrs_define
class RunsStateChangesList200Response:
    """RunsStateChangesList200Response

    Attributes:
        data (list[RunStateChange] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[RunStateChange] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[RunStateChange] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = RunStateChange.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[RunStateChange] | None | Unset, data)
        ...
        runs_state_changes_list_200_response = cls(
            data=data,
            links=links,
        )

        runs_state_changes_list_200_response.additional_properties = d
        return runs_state_changes_list_200_response
