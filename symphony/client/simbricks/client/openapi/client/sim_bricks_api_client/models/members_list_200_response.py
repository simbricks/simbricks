...
T = TypeVar("T", bound="MembersList200Response")
...
class MembersList200Response:
    ...
    Attributes:
        data (list[NsMember] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[NsMember] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[NsMember] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = NsMember.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[NsMember] | None | Unset, data)
        ...
        members_list_200_response = cls(
            data=data,
            links=links,
        )

        members_list_200_response.additional_properties = d
        return members_list_200_response
