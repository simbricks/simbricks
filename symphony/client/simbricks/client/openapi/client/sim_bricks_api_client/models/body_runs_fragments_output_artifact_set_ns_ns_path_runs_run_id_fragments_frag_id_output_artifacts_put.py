...
T = TypeVar("T", bound="BodyRunsFragmentsOutputArtifactSetNsNsPathRunsRunIdFragmentsFragIdOutputArtifactsPut")


@_attrs_define
class BodyRunsFragmentsOutputArtifactSetNsNsPathRunsRunIdFragmentsFragIdOutputArtifactsPut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_runs_fragments_output_artifact_set_ns_ns_path_runs_run_id_fragments_frag_id_output_artifacts_put = cls(
            file=file,
        )

        body_runs_fragments_output_artifact_set_ns_ns_path_runs_run_id_fragments_frag_id_output_artifacts_put.additional_properties = d
        return body_runs_fragments_output_artifact_set_ns_ns_path_runs_run_id_fragments_frag_id_output_artifacts_put
