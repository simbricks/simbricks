...
class KillRunReq:
    ...
    Attributes:
        ...
        discriminator (Literal['KillRunReq'] | Unset):  Default: 'KillRunReq'.
    """

    run_id: str
    id: None | str | Unset = UNSET
    produced_at: datetime.datetime | Unset = UNSET
    discriminator: Literal["KillRunReq"] | Unset = "KillRunReq"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if discriminator != "KillRunReq" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'KillRunReq', got '{discriminator}'")
        ...
        kill_run_req.additional_properties = d
        return kill_run_req
