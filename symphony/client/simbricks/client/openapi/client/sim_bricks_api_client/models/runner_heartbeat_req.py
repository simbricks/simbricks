...
T = TypeVar("T", bound="RunnerHeartbeatReq")


@_attrs_define
class RunnerHeartbeatReq:
    """
    Attributes:
        id (None | str | Unset): API Object id
        produced_at (datetime.datetime | Unset):
        discriminator (Literal['RunnerHeartbeatReq'] | Unset):  Default: 'RunnerHeartbeatReq'.
    """

    id: None | str | Unset = UNSET
    produced_at: datetime.datetime | Unset = UNSET
    discriminator: Literal["RunnerHeartbeatReq"] | Unset = "RunnerHeartbeatReq"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if discriminator != "RunnerHeartbeatReq" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'RunnerHeartbeatReq', got '{discriminator}'")

        runner_heartbeat_req = cls(
            id=id,
            produced_at=produced_at,
            discriminator=discriminator,
        )

        runner_heartbeat_req.additional_properties = d
        return runner_heartbeat_req
