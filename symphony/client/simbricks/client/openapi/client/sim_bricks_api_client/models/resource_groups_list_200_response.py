...
T = TypeVar("T", bound="ResourceGroupsList200Response")


@_attrs_define
class ResourceGroupsList200Response:
    """ResourceGroupsList200Response

    Attributes:
        data (list[ResourceGroup] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[ResourceGroup] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[ResourceGroup] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = ResourceGroup.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[ResourceGroup] | None | Unset, data)
        ...
        resource_groups_list_200_response = cls(
            data=data,
            links=links,
        )

        resource_groups_list_200_response.additional_properties = d
        return resource_groups_list_200_response
