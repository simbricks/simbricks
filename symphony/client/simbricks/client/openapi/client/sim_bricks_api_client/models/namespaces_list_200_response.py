...
T = TypeVar("T", bound="NamespacesList200Response")


@_attrs_define
class NamespacesList200Response:
    """NamespacesList200Response

    Attributes:
        data (list[Namespace] | None | Unset):
        links (None | PaginationLinks | Unset):
    """

    data: list[Namespace] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> list[Namespace] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for data_type_0_item_data in _data_type_0:
                    data_type_0_item = Namespace.from_dict(data_type_0_item_data)
                ...
                pass
            return cast(list[Namespace] | None | Unset, data)
        ...
        namespaces_list_200_response = cls(
            data=data,
            links=links,
        )

        namespaces_list_200_response.additional_properties = d
        return namespaces_list_200_response
