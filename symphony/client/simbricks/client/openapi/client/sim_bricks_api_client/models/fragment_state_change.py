...
T = TypeVar("T", bound="FragmentStateChange")
...
class FragmentStateChange:
    ...
    Attributes:
        ...
        discriminator (Literal['FragmentStateChange'] | Unset):  Default: 'FragmentStateChange'.
    """
    ...
    discriminator: Literal["FragmentStateChange"] | Unset = "FragmentStateChange"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discriminator = cast(Literal["FragmentStateChange"] | Unset, d.pop("discriminator", UNSET))
        if discriminator != "FragmentStateChange" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'FragmentStateChange', got '{discriminator}'")

        fragment_state_change = cls(
            run_fragment_id=run_fragment_id,
            run_id=run_id,
            run_state=run_state,
            id=id,
        ...
        fragment_state_change.additional_properties = d
        return fragment_state_change
