...
class ProxyOutput:
    ...
    Attributes:
        ...
        discriminator (Literal['ProxyOutput'] | Unset):  Default: 'ProxyOutput'.
    """
    ...
    discriminator: Literal["ProxyOutput"] | Unset = "ProxyOutput"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if discriminator != "ProxyOutput" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'ProxyOutput', got '{discriminator}'")
        ...
        proxy_output.additional_properties = d
        return proxy_output
