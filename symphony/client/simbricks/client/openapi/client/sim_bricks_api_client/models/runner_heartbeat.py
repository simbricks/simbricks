...
class RunnerHeartbeat:
    ...
    Attributes:
        ...
        discriminator (Literal['RunnerHeartbeat'] | Unset):  Default: 'RunnerHeartbeat'.
    """

    id: None | str | Unset = UNSET
    produced_at: datetime.datetime | Unset = UNSET
    discriminator: Literal["RunnerHeartbeat"] | Unset = "RunnerHeartbeat"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discriminator = cast(Literal["RunnerHeartbeat"] | Unset, d.pop("discriminator", UNSET))
        if discriminator != "RunnerHeartbeat" and not isinstance(discriminator, Unset):
            raise ValueError(f"discriminator must match const 'RunnerHeartbeat', got '{discriminator}'")
