...
from ...models.namespaces_list_200_response import NamespacesList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ns/{ns_path}/-/children".format(
...
) -> HTTPValidationError | InlineObject | NamespacesList200Response | None:
    if response.status_code == 200:
        response_200 = NamespacesList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | NamespacesList200Response]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve namespace&#39;s child namespaces
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | NamespacesList200Response
    """
