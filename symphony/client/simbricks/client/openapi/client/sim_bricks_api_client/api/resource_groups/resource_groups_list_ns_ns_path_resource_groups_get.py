...
from ...models.resource_groups_list_200_response import ResourceGroupsList200Response
...
) -> HTTPValidationError | InlineObject | ResourceGroupsList200Response | None:
    if response.status_code == 200:
        response_200 = ResourceGroupsList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | ResourceGroupsList200Response]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | ResourceGroupsList200Response
    """
