...
from ...models.simulations_list_200_response import SimulationsList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    json_system: None | str | Unset
    if isinstance(system, Unset):
        json_system = UNSET
    else:
        json_system = system
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ns/{ns_path}/-/simulations".format(
...
) -> HTTPValidationError | InlineObject | SimulationsList200Response | None:
    if response.status_code == 200:
        response_200 = SimulationsList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | SimulationsList200Response]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve namespace&#39;s simulations
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | SimulationsList200Response
    """
