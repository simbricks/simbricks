...
) -> HTTPValidationError | InlineObject | System | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | System]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | System
    """
