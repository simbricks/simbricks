...
from ...models.runs_state_changes_list_200_response import RunsStateChangesList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ns/{ns_path}/-/runs/{run_id}/state-changes".format(
...
) -> HTTPValidationError | InlineObject | RunsStateChangesList200Response | None:
    if response.status_code == 200:
        response_200 = RunsStateChangesList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | RunsStateChangesList200Response]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve list of run&#39;s state changes

    Args:
        ns_path (str): Full namespace path
        run_id (str):
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | RunsStateChangesList200Response
    """
