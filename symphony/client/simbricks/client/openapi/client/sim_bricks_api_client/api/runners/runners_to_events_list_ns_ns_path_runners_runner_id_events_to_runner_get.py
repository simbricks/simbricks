...
from ...models.runners_to_events_list_200_response import RunnersToEventsList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ns/{ns_path}/-/runners/{runner_id}/events-to-runner".format(
...
) -> HTTPValidationError | InlineObject | RunnersToEventsList200Response | None:
    if response.status_code == 200:
        response_200 = RunnersToEventsList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | RunnersToEventsList200Response]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve events passing from backend to runner.
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | RunnersToEventsList200Response
    """
