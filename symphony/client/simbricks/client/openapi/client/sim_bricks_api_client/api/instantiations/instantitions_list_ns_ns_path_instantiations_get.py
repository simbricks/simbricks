...
from ...models.instantitions_list_200_response import InstantitionsList200Response
...
def _get_kwargs(
    ...
    *,
    ...
    simulation: None | str | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_simulation: None | str | Unset
    if isinstance(simulation, Unset):
        json_simulation = UNSET
    else:
        json_simulation = simulation
    params["simulation"] = json_simulation

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/ns/{ns_path}/-/instantiations".format(
...
) -> HTTPValidationError | InlineObject | InstantitionsList200Response | None:
    if response.status_code == 200:
        response_200 = InstantitionsList200Response.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | InstantitionsList200Response]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | InstantitionsList200Response
    """
