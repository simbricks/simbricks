...
from ...models.body_instantiations_fragment_input_artifact_set_ns_ns_path_instantiations_inst_id_fragments_frag_id_input_artifact_put import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/ns/{ns_path}/-/instantiations/{inst_id}/fragments/{frag_id}/input-artifact".format(
