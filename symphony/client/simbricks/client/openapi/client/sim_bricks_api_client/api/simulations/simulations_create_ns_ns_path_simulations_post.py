...
) -> HTTPValidationError | InlineObject | Simulation | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | InlineObject | Simulation]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ns_path (str):
        body (Simulation | Unset): Simulation
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | InlineObject | Simulation
    """
